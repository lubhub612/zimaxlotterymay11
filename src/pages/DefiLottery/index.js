...
export default function DefiLottery() {
 ...
 //   handleLottery()
  ...
  const handlePrizePool = async () => {
    ...
    /*const zmxToBurn = zmxToBurn1.div(100).mul(new BigNumber(values.amountCollectedInZMX))
    console.log(values);
    console.log(values.treasuryFee);
    console.log(values.treasuryFee*1);
    console.log(values.amountCollectedInZMX);
    console.log(values.amountCollectedInZMX*1);
    console.log(values.ZMXPerBracket);
    console.log(values.countWinnersPerBracket);
    console.log(values.rewardsBreakdown);
    console.log(feeAsPercentage);
    console.log(amountCollectedInZMX);
    console.log(zmxToBurn1);
    console.log(zmxToBurn);
   console.log(amountLessTreasuryFee); */
  } catch (error) {
    console.log("error while getting Round");
    console.log(error)
  }
  ...
  const handlePrizePoolRound = async () => {
   ...
   // const result = Object.keys(winner).map();
   // setCountWinnersPerBracketRound(result)
    //const zmxToBurn = zmxToBurn1.div(100).mul(new BigNumber(values.amountCollectedInZMX))
    console.log(values);
    //console.log(values.treasuryFee);
   // console.log(values.treasuryFee*1);
   ...
   // console.log(values.amountCollectedInZMX*1);
   // console.log(values.ZMXPerBracket);
   // console.log("a " , values.countWinnersPerBracket);
   // console.log("a " , result);
   // console.log("a " , values.countWinnersPerBracket[0]); 
   // console.log("a " , values.countWinnersPerBracket[0]._hex); 
   // let winner1 = (values.countWinnersPerBracket[0]._hex)*1;
   /// console.log("a " , winner1);
  //  console.log(values.rewardsBreakdown);
  //  console.log(feeAsPercentage);
  //  console.log(amountCollectedInZMX);
   // console.log(zmxToBurn1);
            ...
            {lotteryDetails5 ? (
              <div className="ticket-footer-details">
                ...
                {rewardBrackets &&
                  ...
                  <li>
                  {/*}  <strong>Match first {item+1}</strong>{' '}  */}
                    {getRewardText(item)}
                    <p>
                  {/*    <CountUp end={425} /> */}
...
{lotteryDetails21 ? (
              <div className="ticket-footer-details">
                ...
                {/*}  <p>{getRoundNumberWinner(item)}</p>
                   {/* <p>{getZmxRewardsRoundWinner(item)} </p> ZMX Each  */}
                   {/*} <span>
                  ~$ {getZmxRewardsUSD(item)}
                      ~$ <CountUp end={1731} />
                  </span> */}
